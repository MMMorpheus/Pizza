...
export const Sort: FC = () => {
  const { sortOption } = useAppSelector(optionsSelector);
  ...
  return (
    <div ref={popUpRef} className={styles["sort_options"]}>
      <div className={clsx(styles.triangle, isOpened && styles._active)}></div>
      <div>
        Сортування за:
        <span
